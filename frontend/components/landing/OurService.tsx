...
const Card = ({ title, description, image }: CardType) => {
  return (
    <div className="bg-[#fefefe] shadow-[0_8px_24px_rgba(0,0,0,0.12)] hover:shadow-[0_12px_40px_rgba(0,0,0,0.15)] pb-8 rounded-xl mx-auto w-5/6 transition-shadow duration-300 ease-in-out">
